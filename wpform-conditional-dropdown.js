...
document.addEventListener('DOMContentLoaded', function () {
    const sheetURL = "https://docs.google.com/spreadsheets/d/1E_ZiZeuZR6yQCa09CBubUT5Icuk7sGtZo3cUJeWQDJE/gviz/tq?tqx=out:json";
    ...
    function formatCellValue(cell) {
        if (!cell) return '';
        if (cell.f) return cell.f; // Use formatted value if available (e.g., dates)
        return cell.v;
    }
